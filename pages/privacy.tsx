...
const Privacy: NextPage = () => {
  return (
    <>
      <h1>Cookie Policy for Life School Ghana</h1>

      <p>
        This is the Cookie Policy for Life School Ghana, accessible from
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            these to work the following social media sites including; WhatsApp,
            will set cookies through our site which may be used to enhance your
