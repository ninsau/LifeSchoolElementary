...
const Terms: NextPage = () => {
  return (
    <>
      <div className="py-12 mx-10 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              Welcome to Life School Ghana!
            </p>
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              These terms and conditions outline the rules and regulations for
              the use of Life School Ghana&apos;s Website, located at
              https://www.lifeschoolghana.com.
              <br />
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use Life School Ghana if you do not
              ...
              We employ the use of cookies. By accessing Life School Ghana, you
              agreed to use cookies in agreement with the Life School
              Ghana&apos;s Privacy Policy.
              <br />
              ...
              Unless otherwise stated, Life School Ghana and/or its licensors
              own the intellectual property rights for all material on Life
              School Ghana. All intellectual property rights are reserved. You
              may access this from Life School Ghana for your own personal use
              subjected to restrictions set in these terms and conditions.
              <br />
              You must not:
              <br />
              Republish material from Life School Ghana
              <br />
              Sell, rent or sub-license material from Life School Ghana
              <br />
              Reproduce, duplicate or copy material from Life School Ghana
              <br />
              Redistribute content from Life School Ghana
              <br />
              ...
              Life School Ghana does not filter, edit, publish or review
              Comments prior to their presence on the website. Comments do not
              reflect the views and opinions of Life School Ghana,its agents
              ...
              by applicable laws, Life School Ghana shall not be liable for the
              ...
              <br />
              <br />
              Life School Ghana reserves the right to monitor all Comments and
              ...
              <br />
              You hereby grant Life School Ghana a non-exclusive license to use,
              ...
              the absence of Life School Ghana; and (d) the link is in the
              ...
              by sending an e-mail to Life School Ghana. Please include your
              ...
              format of content on the linking party’s site. No use of Life
              School Ghana&apos;s logo or other artwork will be allowed for
              ...
              applicable law. The limitations and prohibitions of liability set
              in this Section and elsewhere in this disclaimer: (a) are subject
              to the preceding paragraph; and (b) govern all liabilities arising
              ...
              and the information and services on the website are provided free
              of charge, we will not be liable for any loss or damage of any
              nature.
            </p>
          </div>
        </div>
